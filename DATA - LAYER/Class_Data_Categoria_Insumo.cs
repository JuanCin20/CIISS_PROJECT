    ...
    public class Class_Data_Categoria_Insumo
    {
        public List<Class_Entity_Categoria_Insumo> Class_Data_Categoria_Insumo_Listar()
        {
            ...
            try
            {
                ...
                {
                    string SQL_Server_Query_String = "SELECT ID_Categoria_Insumo, Nombre_Categoria_Insumo, Descripcion_Categoria_Insumo, Estado_Categoria_Insumo, CONVERT(VARCHAR(10), Fecha_Registro_Categoria_Insumo, 103) FROM Tabla_Categoria_Insumo;";
