...
$(document).ready(function () {
    ...
    $("#Initial_Fecha_Movimiento_Inventario").datepicker({ dateFormat: "dd/mm/yy" }).datepicker("setDate", new Date());
    $("#Final_Fecha_Movimiento_Inventario").datepicker({ dateFormat: "dd/mm/yy" }).datepicker("setDate", new Date());
            ...
            var Chart_05_Alternative = new Chart(Chart_05, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            data: Array_02,
                            backgroundColor: ["rgb(255, 155, 205)", "rgb(255, 205, 255)"],
                        },
                    ],
                },
            });
